...
export default function OnboardingPage() {
   ...
   * 从启动页进入首页
   */
  const handleGoHome = withErrorHandler(() => {
    markOnboardingAsSeen();
    safeReLaunch('/pages/index/index');
  }, '进入首页失败，请稍后重试');
  ...
  return (
    <View className="onboarding-page">
      ...
      >
        <Text className="onboarding-page__skip onboarding-page__skip--left" onClick={handleSkip}>跳过</Text>
      ...
      >
        <SwiperItem>
          <View className="onboarding-page__slide">
            ...
            <View className="onboarding-page__footer onboarding-page__footer--single">
              <Button
        ...
        <SwiperItem>
          <View className="onboarding-page__slide">
            ...
            <View className="onboarding-page__content onboarding-page__content--screen2">
              <Text className="onboarding-page__title onboarding-page__title--screen2">你的热爱与天赋，都有生物学根源</Text>
              <View className="onboarding-page__point">
                <Text className="onboarding-page__point-title">喜欢·FUEL</Text>
                <Text className="onboarding-page__point-desc">
                  为什么有的事你能废寝忘食？——这是你的能量燃料
                </Text>
              </View>
              <View className="onboarding-page__point">
                <Text className="onboarding-page__point-title">天赋·ALGORITHM</Text>
                <Text className="onboarding-page__point-desc">
            ...
            <View className="onboarding-page__footer onboarding-page__footer--split">
              <Text className="onboarding-page__hint" onClick={() => setCurrent(2)}>
                滑屏浏览 ➜
              </Text>
              <Button className="onboarding-page__button" size="lg" onClick={() => setCurrent(2)}>
                下一屏 ▶
              </Button>
            </View>
          </View>
          ...
          <View className="onboarding-page__slide">
            ...
            <View className="onboarding-page__content">
              ...
              <View className="onboarding-page__step-line">
                ...
                <Text className="onboarding-page__step-text">168 题深度评估（30 分钟，无需背景知识）</Text>
              </View>
              <View className="onboarding-page__step-line">
                <Text className="onboarding-page__step-no">2</Text>
                <Text className="onboarding-page__step-text">AI 生命图谱（能力雷达图 + 潜能热力图）</Text>
              </View>
              <View className="onboarding-page__step-line">
                <Text className="onboarding-page__step-no">3</Text>
                <Text className="onboarding-page__step-text">精准匹配本命专业（1914 全量专业库交叉比对）</Text>
              </View>
            ...
            <View className="onboarding-page__footer onboarding-page__footer--split">
              <Text className="onboarding-page__hint" onClick={() => setCurrent(3)}>
                滑屏浏览 ➜
              </Text>
              <Button className="onboarding-page__button" size="lg" onClick={() => setCurrent(3)}>
                下一屏 ▶
              </Button>
            </View>
          </View>
